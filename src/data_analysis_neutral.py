...
# Load raw data
df_raw = pd.read_csv("data/raw_results_neutral.csv", parse_dates=["timestamp"])

reliable = pd.read_csv("results/processed_sources_reliable_neutral.csv")
unreliable = pd.read_csv("results/processed_sources_unreliable_neutral.csv")
mixed = pd.read_csv("results/processed_sources_mixed_neutral.csv")
...
plt.tight_layout()
plt.savefig('results/figures/Q1_credibility_distribution_neutral.png', dpi=150, bbox_inches='tight')
plt.close()
print("Saved: results/figures/Q1_credibility_distribution_neutral.png")
...
plt.tight_layout()
plt.savefig('results/figures/Q2_top_unreliable_domains_neutral.png', dpi=150, bbox_inches='tight')
plt.close()
print("Saved: results/figures/Q2_top_unreliable_domains_neutral.png")
...
plt.tight_layout()
plt.savefig('results/figures/Q3_position_analysis_neutral.png', dpi=150, bbox_inches='tight')
plt.close()
print("Saved: results/figures/Q3_position_analysis_neutral.png")
...
plt.tight_layout()
plt.savefig('results/figures/Q4_topics_unreliable_neutral.png', dpi=150, bbox_inches='tight')
plt.close()
print("Saved: results/figures/Q4_topics_unreliable_neutral.png")
...
plt.tight_layout()
plt.savefig('results/figures/Q5_topics_reliable_neutralized.png', dpi=150, bbox_inches='tight')
plt.close()
print("Saved: results/figures/Q5_topics_reliable_neutralized.png")
...
plt.tight_layout()
plt.savefig('results/figures/Q6_reliable_vs_unreliable_topics_neutral.png', dpi=150, bbox_inches='tight')
plt.close()
print("Saved: results/figures/Q6_reliable_vs_unreliable_topics_neutral.png")
...
plt.tight_layout()
plt.savefig('results/figures/overall_credibility_pie_neutral.png', dpi=150, bbox_inches='tight')
plt.close()
print("Saved: results/figures/overall_credibility_pie_neutral.png")
...
summary_df.to_csv("results/analysis_summary_neutral.csv", index=False)
...
plt.tight_layout()
plt.savefig('results/figures/summary_table_neutral.png', dpi=150, bbox_inches='tight')
plt.close()
print("Saved: results/figures/summary_table_neutral.png")
